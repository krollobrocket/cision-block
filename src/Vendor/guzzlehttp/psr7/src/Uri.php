...
use CisionBlock\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `CisionBlock\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `CisionBlock\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
